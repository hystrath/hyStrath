...
Description
    ...
    Use the -incompressible option for incompressible cases.
...
)
{
    ...
    Info<< "Components : " << uInfx.value() << " " << uInfy.value() << " " 
        << uInfz.value() << nl << endl;
    ...
    forAll(wallPatches, patchi)
    {
      ...
      {  
          ...
          (   
              "myIdentityVector",
              dimless,             
              Foam::vector (1.0, 1.0, 1.0)
          );
          dimensionedVector myXVector 
          (   
              "myXVector",
              dimless,             
              Foam::vector (1.0, 0.0, 0.0)
          );
          dimensionedVector myYVector 
          (   
              "myYVector",
              dimless,             
              Foam::vector (0.0, 1.0, 0.0)
          );
          dimensionedVector myZVector 
          (   
              "myZVector",
              dimless,             
              Foam::vector (0.0, 0.0, 1.0)
          );
          ...
          Cf.boundaryFieldRef()[patchi] = fricCoeff.boundaryField()[patchi];
          const scalarField& Cfric = Cf.boundaryField()[patchi];
          Cn.boundaryFieldRef()[patchi] = fricNormalCoeff.boundaryField()[patchi];
          const scalarField& CNfric = Cn.boundaryField()[patchi];
          Cw.boundaryFieldRef()[patchi] = fricWallCoeff.boundaryField()[patchi];
          ...
          Cfx.boundaryFieldRef()[patchi] = fricCoeffx.boundaryField()[patchi];
          Cfy.boundaryFieldRef()[patchi] = fricCoeffy.boundaryField()[patchi];
          Cfz.boundaryFieldRef()[patchi] = fricCoeffz.boundaryField()[patchi];
          Cnx.boundaryFieldRef()[patchi] = fricNormalCoeffx.boundaryField()[patchi];
          Cny.boundaryFieldRef()[patchi] = fricNormalCoeffy.boundaryField()[patchi];
          Cnz.boundaryFieldRef()[patchi] = fricNormalCoeffz.boundaryField()[patchi]; 
          Cwx.boundaryFieldRef()[patchi] = fricWallCoeffx.boundaryField()[patchi];
          Cwy.boundaryFieldRef()[patchi] = fricWallCoeffy.boundaryField()[patchi];
          Cwz.boundaryFieldRef()[patchi] = fricWallCoeffz.boundaryField()[patchi];               
      }
      else
      {
