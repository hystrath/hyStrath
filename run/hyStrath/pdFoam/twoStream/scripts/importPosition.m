function [x] = importPosition(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [X,TYPEID] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [X,TYPEID] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [x,typeID] = importfile('positions',1, 41472);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/09/03 16:12:05
