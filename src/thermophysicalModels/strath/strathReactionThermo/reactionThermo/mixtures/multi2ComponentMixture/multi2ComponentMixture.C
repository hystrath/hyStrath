...
void Foam::multi2ComponentMixture<ThermoType>::correctMassFractions()
{
    ...
    if(initialiseY)
    {
        ...
        {    
            ...
            scalarField& YCells = Y_[speciei].internalField();
        ...
        forAll(Y_[0].boundaryField(), patchi)
        {
            forAll(Y_, speciei)
            {
                ...
                fvPatchScalarField& pY = Y_[speciei].boundaryField()[patchi];
...
Foam::multi2ComponentMixture<ThermoType>::molWeightMixture() const
{
    ...
    volScalarField& molWeightMixture = tmolWeightMixture();
    scalarField& molWeightMixtureCells = molWeightMixture.internalField();
