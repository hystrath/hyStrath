...
namespace Foam
{
    ...
    {
        defineTypeNameAndDebug(hardSphere, 0);
...
Foam::basicMfpModels::hardSphere::hardSphere
(
    const word& name,
...
Foam::basicMfpModels::hardSphere::mfp() const
{
    ...
    forAll(this->T_.boundaryField(), patchi)
    {
        ...
        forAll(pTt, facei)
        {
            pmfp[facei] = 16.0/5.0*sqrt(molW_/(constant::mathematical::twoPi*constant::physicoChemical::R.value()*pTt[facei]));
        }
    }
...
Foam::tmp<Foam::scalarField> Foam::basicMfpModels::hardSphere::mfp
(
    const label patchi,
    const scalarField& p,
...
) const
{
    ...
    forAll(Tt, facei)
    {
        mfp[facei] = 16.0/5.0*sqrt(molW_/(constant::mathematical::twoPi*constant::physicoChemical::R.value()*Tt[facei]));
    }
