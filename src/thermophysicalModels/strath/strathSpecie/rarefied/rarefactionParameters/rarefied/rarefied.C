...
void Foam::rarefied<ThermoType>::correct(const volVectorField& U)
{
    if(computeRarefaction_)
    {
        ...
        scalarField& mfpMixCells = mfpMix_.internalField();
        ...
        forAll(rho.boundaryField(), patchi)
        {
            ...
            {
                innerSum.boundaryField()[patchi][facei] = 0.0;
                outerSum.boundaryField()[patchi][facei] = 0.0;
                nDmix.boundaryField()[patchi][facei] = 0.0;
                tMfpMix.boundaryField()[patchi][facei] = 0.0;
            }
        }
        ...
        {  
            ...
            scalarField& mfpCells = mfp.internalField();
            ...
            if(not oldMfpDefinition_ /*and species().size() > 1*/) // NEW VINCENT 03/08/2016
            {
                ...
                forAll(species(), speciej)
                {
                    ...
                    forAll(T.boundaryField(), patchi)
                    {
                        ...
                        fvPatchScalarField& pInnerSum = innerSum.boundaryField()[patchi]; 
                ...
                forAll(nDi.boundaryField(), patchi)
                {
                    ...
                    fvPatchScalarField& pOuterSum = outerSum.boundaryField()[patchi];  
        ...
        scalarField& KnovCells = Knov_.internalField();
        scalarField& KnGLLCells = KnGLL_.internalField();
        scalarField& KnGLLCellsRho = KnsGLL_[0].internalField();
        scalarField& KnGLLCellsT = KnsGLL_[1].internalField();
        scalarField& KnGLLCellsU = KnsGLL_[2].internalField();
        ...
        forAll(rho.boundaryField(), patchi)
        {
            ...
            fvPatchScalarField& pmfpMix = mfpMix_.boundaryField()[patchi];
            fvPatchScalarField& pKnov = Knov_.boundaryField()[patchi];
            fvPatchScalarField& pKnGLL = KnGLL_.boundaryField()[patchi];
            fvPatchScalarField& pKnGLLRho = KnsGLL_[0].boundaryField()[patchi];
            fvPatchScalarField& pKnGLLT = KnsGLL_[1].boundaryField()[patchi];
            fvPatchScalarField& pKnGLLU = KnsGLL_[2].boundaryField()[patchi];
    ...
    else if(computeMfpBoundaries_)
    {
        if(oldMfpDefinition_)
        {
            ...
            {  
                ...
                tMfpMix.boundaryField() += X.boundaryField()*mfp.boundaryField();
        ...
        else
        {
            ...
            {  
                ...
                nDmix.boundaryField() += nDi.boundaryField();
            }
