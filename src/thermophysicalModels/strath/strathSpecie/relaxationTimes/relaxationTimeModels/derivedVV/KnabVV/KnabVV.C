...
void Foam::KnabVV<ThermoType>::correct()
{
    ...
    {  
        ...
        scalarField& QVVCells = QVV.internalField();
        ...
        forAll(solvedVibEqSpecies(), speciej)
        {
            ...
            { 
                ...
                {        
                    ...
                    fvPatchScalarField& pQVV = QVV.boundaryField()[patchi];
                    pQVV = 0;
        ...
        QVV.internalField() *= constant::physicoChemical::NA.value()*pD.internalField()
            *sqrt(8.0*constant::physicoChemical::R.value()*Tt.internalField()/constant::mathematical::pi);
            
        QVV.boundaryField() *= constant::physicoChemical::NA.value()*pD.boundaryField()
