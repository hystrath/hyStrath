...
defineTypeNameAndDebug(ciliumIC, 0);

addToRunTimeSelectionTable(polyConfiguration, ciliumIC, dictionary);
...
void ciliumIC::setInitialConfiguration()
{
...
void ciliumIC::insertMoleculeLocal
(
