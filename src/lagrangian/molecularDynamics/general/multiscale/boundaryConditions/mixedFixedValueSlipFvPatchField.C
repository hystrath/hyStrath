...
//Field<Type> slipVel = (valueFraction_*refValue_
//      +
//        (1.0 - valueFraction_)
...
// scalarField slipLen = mag(slipVel) / mag(shear);
// Info << "Slip Length = " << slipLen << endl;
// Info << "Slip Velocity = " << slipVel << endl;
 //Info << "Shear = " << shear << endl;
