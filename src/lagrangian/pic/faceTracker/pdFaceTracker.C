...
pdFaceTracker::~pdFaceTracker()
{
    //Info << "pdFaceTracker Destructor" << endl;
}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void pdFaceTracker::clean()
{
...
void pdFaceTracker::updateFields
(
    pdParcel& p
)
{
    ...
    const pdParcel::constantProperties& constProp = cloud_.constProps(typeId);
...
//     const vector mom = p.U()*mass;
    ...
    //- direction of pdParcel trajectory with respect to the face normal
