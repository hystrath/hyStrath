...
defineTypeNameAndDebug(pdZone, 0);

addToRunTimeSelectionTable(pdField, pdZone, dictionary);
...
void pdZone::updateProperties(const dictionary& newDict)
{
