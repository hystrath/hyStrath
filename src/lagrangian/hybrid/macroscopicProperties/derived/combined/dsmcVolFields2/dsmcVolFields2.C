...
defineTypeNameAndDebug(dsmcVolFields2, 0);

addToRunTimeSelectionTable(dsmcField, dsmcVolFields2, dictionary);
    ...
    measureErrors_(false)
{
    ...
    forAll(moleculesReduced, i)
    {
        ...
        if(typeId == -1)
        {
            FatalErrorIn("dsmcVolFields2::dsmcVolFields2()")
...
//- initial conditions
void dsmcVolFields2::createField()
{
    Info << "Initialising dsmcVolFields2 field" << endl;
}


void dsmcVolFields2::calculateField()
{  
    nTimeSteps_ += 1.0;
...
//- write field
void dsmcVolFields2::writeField()
{
    dsmcRhoN_.write();
    rhoN_.write();
    rhoM_.write();
...
void dsmcVolFields2::updateProperties(const dictionary& newDict)
{
