...
defineTypeNameAndDebug(dsmcMeshFillHybrid, 0);

addToRunTimeSelectionTable(dsmcConfiguration, dsmcMeshFillHybrid,
    dictionary);
...
dsmcMeshFillHybrid::dsmcMeshFillHybrid
(
    dsmcCloud& cloud,
...
void dsmcMeshFillHybrid::setInitialConfiguration()
{
