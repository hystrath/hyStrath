...
#include "dsmcMeshFillFromCFDHybrid2.H"
...
defineTypeNameAndDebug(dsmcMeshFillFromCFDHybrid2, 0);

addToRunTimeSelectionTable(dsmcConfiguration, dsmcMeshFillFromCFDHybrid2,
    dictionary);
...
dsmcMeshFillFromCFDHybrid2::dsmcMeshFillFromCFDHybrid2
(
    dsmcCloud& cloud,
...
void dsmcMeshFillFromCFDHybrid2::setInitialConfiguration()
{
