...
#include "dsmcMeshFillFromCFDHybridMulti.H"
...
defineTypeNameAndDebug(dsmcMeshFillFromCFDHybridMulti, 0);

addToRunTimeSelectionTable(dsmcConfiguration, dsmcMeshFillFromCFDHybridMulti,
    dictionary);
...
dsmcMeshFillFromCFDHybridMulti::dsmcMeshFillFromCFDHybridMulti
(
    dsmcCloud& cloud,
...
void dsmcMeshFillFromCFDHybridMulti::setInitialConfiguration()
{
