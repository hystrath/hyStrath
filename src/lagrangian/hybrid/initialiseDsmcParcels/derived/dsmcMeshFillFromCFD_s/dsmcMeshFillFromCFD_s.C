...
#include "dsmcMeshFillFromCFD_s.H"
...
defineTypeNameAndDebug(dsmcMeshFillFromCFD_s, 0);

addToRunTimeSelectionTable(dsmcConfiguration, dsmcMeshFillFromCFD_s,
    dictionary);
...
dsmcMeshFillFromCFD_s::dsmcMeshFillFromCFD_s
(
    dsmcCloud& cloud,
...
void dsmcMeshFillFromCFD_s::setInitialConfiguration()
{
