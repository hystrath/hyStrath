...
defineTypeNameAndDebug(dsmcMeshFillFromCFD, 0);

addToRunTimeSelectionTable(dsmcConfiguration, dsmcMeshFillFromCFD,
    dictionary);
...
dsmcMeshFillFromCFD::dsmcMeshFillFromCFD
(
    dsmcCloud& cloud,
...
void dsmcMeshFillFromCFD::setInitialConfiguration()
{
