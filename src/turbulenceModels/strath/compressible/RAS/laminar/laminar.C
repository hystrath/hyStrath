...
{
namespace RAS2Models
{

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

defineTypeNameAndDebug(laminar, 0);
addToRunTimeSelectionTable(RAS2Model, laminar, dictionary);
...
:
    RAS2Model(modelName, rho, U, phi, thermophysicalModel, turbulenceModel2Name)
{}
