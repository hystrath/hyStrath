...
{
    typedef compressible::turbulenceModel2 cmpTurbModel;
    ...
    else if (obr_.foundObject<multi2Thermo>(multi2Thermo::typeName))
    {
        const multi2Thermo& thermo =
            obr_.lookupObject<multi2Thermo>(multi2Thermo::typeName);
...
{
    if (obr_.foundObject<multi2Thermo>("thermophysicalProperties"))
    {
        const multi2Thermo& thermo =
             obr_.lookupObject<multi2Thermo>("thermophysicalProperties");
