...
template<class Type>
Foam::hTCModels::laminar<Type>::laminar
(
...
Foam::hTCModels::laminar<Type>::tc() const
{
...
template<class Type>
void Foam::hTCModels::laminar<Type>::correct()
{
    if (this->active())
    {
        if (integrateReactionRate_)
...
Foam::hTCModels::laminar<Type>::R(volScalarField& Y) const
{
...
template<class Type>
Foam::tmp<Foam::volScalarField>
Foam::hTCModels::laminar<Type>::dQ() const
{
...
template<class Type>
Foam::tmp<Foam::volScalarField>
Foam::hTCModels::laminar<Type>::Sh() const
{
...
template<class Type>
bool Foam::hTCModels::laminar<Type>::read()
{
    if (Type::read())
    {
